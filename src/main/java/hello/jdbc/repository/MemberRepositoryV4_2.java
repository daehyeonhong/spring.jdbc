...
public class MemberRepositoryV4_2 implements MemberRepository {
    private static final Logger log = LoggerFactory.getLogger(MemberRepositoryV4_2.class);
    ...
    public Member save(final Member member) {
        ...
        try {
            ...
            throw Objects.requireNonNull(this.exceptionTranslator.translate("save", sql, sqlException));
        } finally {
    ...
    public Member findById(final String memberId) {
        ...
        try {
            ...
            throw Objects.requireNonNull(this.exceptionTranslator.translate("findById", sql, sqlException));
        } finally {
    ...
    public void update(final String memberId, int money) {
        ...
        try {
            ...
            throw Objects.requireNonNull(this.exceptionTranslator.translate("update", sql, sqlException));
        } finally {
            close(connection, preparedStatement, null);
        }
    }
